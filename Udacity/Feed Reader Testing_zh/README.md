...
* [数组遍历forEach](https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/Array/forEach)
* [Initial Entries 测试用例参考](https://discussions.youdaxue.com/t/topic/53490)
